...
root_path = os.path.abspath("D:/_DEPLOYMENT/Raw Addon")
lib_path = os.path.abspath("D:/_DEPLOYMENT/Sanctum/lib")
addons_xml_path = os.path.join(lib_path, "addons.xml")
addons_md5_path = os.path.join(lib_path, "addons.xml.md5")
        ...
        for filename in filenames:
            if filename == "addon.xml":
                ...
                with open(addon_file, "r", encoding="utf-8") as f:
                    ...
                    if addons_xml.endswith("</addons>"):
                        addons_xml = addons_xml.rstrip("\n")
